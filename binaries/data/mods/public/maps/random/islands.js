...
function* GenerateMap(mapSettings)
{
	...
	if (!isNomad())
	{
		...
		{
			createArea(
				new ClumpPlacer(diskArea(playerIslandRadius), 0.8, 0.1, Infinity,
					playerPosition[i]),
				[
	...
	createObjectGroupsDeprecated(group, 0,
		[
			avoidClasses(clForest, 1, clPlayer, 0, clMetal, 10, clRock, 5, clHill, 1),
	...
	createStragglerTrees(
		...
		[
			avoidClasses(clForest, 1, clHill, 1, clPlayer, 0, clMetal, 6, clRock, 6),
	...
	placePlayersNomad(clPlayer,
		[
			...
			avoidClasses(clHill, 2, clForest, 1, clMetal, 4, clRock, 4, clFood, 2)
		]);
