...
function initGUIButtons()
{
	...
	lobbyButton.size.right = (replayButton.hidden ? Engine.GetGUIObjectByName("continueButton").size.left : replayButton.size.left) - 10;
	lobbyButton.size.left = lobbyButton.size.right - lobbyButtonWidth;
