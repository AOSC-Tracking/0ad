GameSettingControls.PopulationCap = class PopulationCap extends GameSettingControlDropdown
{
	...
	canTotalPopExceedRecommendedMax()
	{
		...
		{
		case "player": return nbPlayers * popCap > this.PopulationCapacityRecommendation;
		case "team": return nbTeams * popCap > this.PopulationCapacityRecommendation;
		case "world": return popCap > this.PopulationCapacityRecommendation;
