toolsAtlasStates.PaintTerrainEyeDropper = class extends FSMv2State
{
	constructor(workingMemory, commandManager, changeStateFn, guiFn, watchFn, setterFn)
	{
		super("paintTerrainEyeDropper");
	...
	onHandleInputAfterGui(ev)
	{
		...
		{
			let texture = MapEditor.GetTerrainTexture(this.workingMemory.brush);
			this.setterFn("guiController", "currentTerrainTexture", texture);
			return true;
		}
		else if (ev.type === SDLConstans.GUI_MAPPINGS_EVENTS.SDL_HOTKEYUP && ev.hotkey === SDLConstans.GUI_MAPPINGS_HOTKEYS.MAPEDITOR_PAINT_EYEDROPPER)
		{
