...
public:
	...
	void SendIqGameReport(const WithRequest& rq, JS::HandleValue data) override;
	void SendIqRegisterGame(const WithRequest& rq, JS::HandleValue data) override;
	...
	JS::Value GUIGetPlayerList(const WithRequest& rq) override;
	JS::Value GUIGetGameList(const WithRequest& rq) override;
	JS::Value GUIGetBoardList(const WithRequest& rq) override;
	JS::Value GUIGetProfile(const WithRequest& rq) override;
