...
public:
	...
	virtual JS::Value ToJSVal(const WithRequest&) const = 0;
	JS::Value ToJSValCached(const WithRequest&) const;
private:
...
CMessage* CMessageFromJSVal(int mtid, const WithRequest&, JS::HandleValue);
