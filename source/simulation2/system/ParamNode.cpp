...
void CParamNode::ToJSVal(const WithRequest& rq, bool cacheValue, JS::MutableHandleValue ret) const
{
...
void CParamNode::ConstructJSVal(const WithRequest& rq, JS::MutableHandleValue ret) const
{
	if (m_Childs.empty())
	{
