...
{
	m_MainLog << html_header0 << engine_display_version << ") Main log" << html_header1;
	m_InterestingLog << html_header0 << engine_display_version << ") Main log (warnings and errors only)" << html_header1;
}
