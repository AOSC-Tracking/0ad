...
template<>
void Script::ToJSVal(const WithRequest& rq, JS::MutableHandleValue ret, const ModDataCPtr& data)
{
...
template<>
bool Script::FromJSVal(const WithRequest&, const JS::HandleValue, ModDataCPtr&)
{
...
template<>
void Script::ToJSVal(const WithRequest& rq, JS::MutableHandleValue ret, const Mod::ModData& data)
{
	ret.set(Script::CreateObject(rq));
	Script::SetProperty(rq, ret, "mod", data.m_Pathname);
	Script::SetProperty(rq, ret, "name", data.m_Name);
...
template<>
bool Script::FromJSVal(const WithRequest& rq, const JS::HandleValue val, Mod::ModData& data)
{
...
namespace JSI_Mod
{
Mod* ModGetter(const WithRequest&, JS::CallArgs&)
{
	return &g_Mods;
}
...
JS::Value GetAvailableMods(const WithRequest& rq)
{
