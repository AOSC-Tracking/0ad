...
static void ToJSVal_unordered_map(const WithRequest& rq, JS::MutableHandleValue ret, const std::unordered_map<T, U>& val)
{
...
template<>
void Script::ToJSVal<std::unordered_map<std::string, std::vector<std::vector<std::string>>>>(const WithRequest& rq, JS::MutableHandleValue ret, const std::unordered_map<std::string, std::vector<std::vector<std::string>>>& val)
{
	ToJSVal_unordered_map(rq, ret, val);
}

template<>
void Script::ToJSVal<std::unordered_map<std::string, std::string>>(const WithRequest& rq, JS::MutableHandleValue ret, const std::unordered_map<std::string, std::string>& val)
{
	ToJSVal_unordered_map(rq, ret, val);
}
 ...
 */
JS::Value GetHotkeyMap(const WithRequest& rq)
{
 ...
 */
JS::Value GetScancodeKeyNames(const WithRequest& rq)
{
...
JS::Value GetConflicts(const WithRequest& rq, JS::HandleValue combination)
{
...
void JSI_Hotkey::RegisterScriptFunctions(const WithRequest& rq)
{
