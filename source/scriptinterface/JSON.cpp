...
bool Script::ParseJSON(const WithRequest& rq, const std::string& string_utf8, JS::MutableHandleValue out)
{
...
void Script::ReadJSONFile(const WithRequest& rq, const VfsPath& path, JS::MutableHandleValue out)
{
...
std::string Script::StringifyJSON(const WithRequest& rq, JS::MutableHandleValue obj, bool indent)
{
	Stringifier str;
...
std::string Script::ToString(const WithRequest& rq, JS::MutableHandleValue obj, bool pretty)
{
	if (obj.isUndefined())
		return "(void 0)";
