...
StructuredClone WriteStructuredClone(const WithRequest& rq, JS::HandleValue v);
void ReadStructuredClone(const WithRequest& rq, const StructuredClone& ptr, JS::MutableHandleValue ret);
