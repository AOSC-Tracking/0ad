...
Script::StructuredClone Script::WriteStructuredClone(const WithRequest& rq, JS::HandleValue v)
{
...
void Script::ReadStructuredClone(const WithRequest& rq, const Script::StructuredClone& ptr, JS::MutableHandleValue ret)
{
	JS::CloneDataPolicy policy;
...
JS::Value Script::DeepCopy(const WithRequest& rq, JS::HandleValue val)
{
