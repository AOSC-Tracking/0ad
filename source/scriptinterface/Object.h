...
inline bool GetProperty(const WithRequest& rq, JS::HandleValue obj, PropType name, JS::MutableHandleValue out)
{
	if (!obj.isObject())
		return false;
...
inline bool GetProperty(const WithRequest& rq, JS::HandleValue obj, PropType name, T& out)
{
...
inline bool GetProperty(const WithRequest& rq, JS::HandleValue obj, const char* name, JS::MutableHandleObject out)
{
...
template<typename T>
inline bool GetPropertyInt(const WithRequest& rq, JS::HandleValue obj, int name, T& out)
{
	return GetProperty(rq, obj, name, out);
}
inline bool GetPropertyInt(const WithRequest& rq, JS::HandleValue obj, int name, JS::MutableHandleValue out)
{
	return GetProperty(rq, obj, name, out);
}
/**
 ...
 */
inline bool HasProperty(const WithRequest& rq, JS::HandleValue obj, const char* name)
{
	if (!obj.isObject())
		return false;
	JS::RootedObject object(rq.cx(), &obj.toObject());
 ...
 */
template<typename PropType>
inline bool SetProperty(const WithRequest& rq, JS::HandleValue obj, PropType name, JS::HandleValue value, bool constant = false, bool enumerable = true)
{
	uint attrs = 0;
	if (constant)
...
template<typename T, typename PropType>
inline bool SetProperty(const WithRequest& rq, JS::HandleValue obj, PropType name, const T& value, bool constant = false, bool enumerable = true)
{
	JS::RootedValue val(rq.cx());
...
template<typename T>
inline bool SetPropertyInt(const WithRequest& rq, JS::HandleValue obj, int name, const T& value, bool constant = false, bool enumerable = true)
{
	return SetProperty<T, int>(rq, obj, name, value, constant, enumerable);
}

template<typename T>
inline bool GetObjectClassName(const WithRequest& rq, JS::HandleObject obj, T& name)
{
 ...
 */
template<typename T>
inline bool GetObjectClassName(const WithRequest& rq, JS::HandleValue val, T& name)
{
...
inline bool DeepFreezeObject(const WithRequest& rq, JS::HandleValue objVal)
{
	if (!objVal.isObject())
	{
 ...
 */
inline bool EnumeratePropertyNames(const WithRequest& rq, JS::HandleValue objVal, bool enumerableOnly, std::vector<std::string>& out)
{
 ...
 */
inline JS::Value CreateObject(const WithRequest& rq)
{
...
inline bool CreateObject(const WithRequest& rq, JS::MutableHandleValue objectValue)
{
...
inline bool CreateObject(const WithRequest& rq, JS::MutableHandleValue objectValue, const char* propertyName, const T& propertyValue, Args const&... args)
{
	JS::RootedValue val(rq.cx());
 ...
 */
inline bool CreateArray(const WithRequest& rq, JS::MutableHandleValue objectValue, size_t length = 0)
{
